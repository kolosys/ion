# ratelimit - Core Concepts

> **Note**: This is a developer-maintained documentation page. The content here is not auto-generated and should be updated manually to explain the core concepts and architecture of the ratelimit package.
...
- [API Reference](../reference/api-reference/ratelimit.md) - Complete API documentation
