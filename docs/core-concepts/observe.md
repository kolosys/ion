# observe - Core Concepts

> **Note**: This is a developer-maintained documentation page. The content here is not auto-generated and should be updated manually to explain the core concepts and architecture of the observe package.
...
- [API Reference](../reference/api-reference/observe.md) - Complete API documentation
